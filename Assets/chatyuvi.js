(function(global) {
    global.$_Tawk_AccountKey = '5fbfeb62920fc91564cb05e8';
    ...
    (function(global) {
        global.$_Tawk.widgetSettings = {
            ...
            "onlineGreeting": {
                ...
                "shortMessage": "Hi! We&#39;re Online",
                "longMessage": ""
            },
            "awayGreeting": {
                "shortMessage": "wait for a moment",
                "longMessage": ""
            },
            "cf": null,
            "emoji": true,
    ...
    (function(u) {
        ...
        try {
            ...
            qa.prototype.log = function(a, b) {
                var f;
                b && a && (b.uiVersion = "v3", b.buildVersion = "695", b.buildCommit = "e15e95f056d56d12773c04eb08c73fa5598007d9", f = {
                    type: a,
                    data: b
            ...
            y.prototype.updateFileProgress = function(a) {
                ...
                b && (180 >= a ? (b.getElementsByClassName("circle-progress-left")[0].style.transform = "rotate(" + a + "deg)", b.getElementsByClassName("circle-progress-right")[0].style.display = "none", b.getElementsByClassName("circle-progress-clip")[0].style.display =
                    "block") : (b.getElementsByClassName("circle-progress-left")[0].style.transform = "rotate(180deg)", b.getElementsByClassName("circle-progress-right")[0].style.transform = "rotate(" + a + "deg)", b.getElementsByClassName("circle-progress-right")[0].style.display = "block", b.getElementsByClassName("circle-progress-clip")[0].style.display = "none"))
            };
            ...
            y.prototype.showCallRequest = function(a, e, f, n) {
                ...
                g || (e = this.ifScrollbarDown(), b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed ? b.chatHandler.webrtcWin.focus() : (g = (n = v.agentProfiles[v.profiles[n.urid]]) && n.pi ? r.agentImgUrl + "/" + n.pi : "default", d = d.replace(/__IMAGE_URL__/, g ? "url('" +
                    g + "');" : "transparent;"), d = d.replace(/__INCOMING_CALL__/, b.languageParser.translate("chat", "incoming_call_message", {
                    name: n.n
                })), d = d.replace(/__ACCEPT_CALL__/, b.languageParser.translate("chat", "accept_call")).replace(/__DECLINE_CALL__/, b.languageParser.translate("chat", "decline_call")), clearTimeout(this.incomingCallTimeout), g = new D("incoming-call"), g.template = d, g.buildView(), d = this.chatContainer.getElementById("chatContainer"), n = d.parentNode, d && n && (n.insertBefore(g.elementReferrer, d), d = this.chatContainer.getElementById("accept-call"),
                    n = this.chatContainer.getElementById("decline-call"), e && this.scrollToBottom(), b.eventHandler.listen(d, this.clickEvent, function() {
                        ...
                        h.removeCallRequest()
                    }, k), c.isPopup || (b.viewHandler.isMaximized ||
                        c.isEmbedded) || (b.viewHandler.indicator.show(), b.viewHandler.messagePreview && b.viewHandler.messagePreview.show(b.viewHandler.indicator.unansweredMessages, null, f)), b.audioPlayer.play("chat_sound"))))
            };
            ...
            y.prototype.subscribeCallUpdate = function(a, e) {
                ...
                }]), f.buildView(), q.getElementById("chatWrapper").insertBefore(f.elementReferrer, q.getElementById("agentTypingContainer")), this.callData[a] = {
                    callView: f
                });
                c = l.getElementsByClassName(f.elementReferrer, "callLoader");
                d = l.getElementsByClassName(f.elementReferrer,
                    "callInfoContainer");
                ...
                b.socketManager.sendToConnector("getCallStatus", {
                    ...
                    q ? (d && d.length && (d[0].style.display = "none"), h && h.length ? h[0].style.display = "block" : (m = t.callError.replace("__HEADER__", b.languageParser.translate("chat",
                            "error_title")).replace("__MESSAGE__", b.languageParser.translate("chat", "call_error_load")).replace("__ACTION__", b.languageParser.translate("notifications", "retry")), h = l.createElement(p.chatContainer.documentRef, "div", null, null, m), h.className = "callErrorContainer", h.style.display = "block", f.elementReferrer.appendChild(h)), (k = l.getElementsByClassName(f.elementReferrer, "retry-load")) && k.length && b.eventHandler.listen(k[0], p.clickEvent, function() {
                            p.subscribeCallUpdate(a, e)
                        }, "retryCallLoad" + a)) : r.data.call.f &&
                        (d && d.length && (d[0].style.display = "block"), callIcon = r.data.call.f.vid ? '<span class="callIcon btn-icon icon-video-chat"></span>' : r.data.call.f.scrn ? '<span class="callIcon btn-icon icon-desktop-sharing"></span>' : '<span class="callIcon btn-icon icon-voice-chat"></span>', g && g.length && (g[0].innerHTML = callIcon), p.callData[a].ver = r.data.call.ver, s && p.scrollToBottom(), p.updateCallView(r.data.call, e))
                })
            };
            y.prototype.updateCallView = function(a, e) {
                ...
                c.ver > a.ver || (h = this.ifScrollbarDown(), c = c.callView, m = c.elementReferrer.getElementsByClassName("btn-icon")[0], callIconContainerEl = c.elementReferrer.getElementsByClassName("callIconContainer")[0], callIconContainerEl.style.backgroundColor = "#47ca2b", "ringing" === a.stts ? ("v" !== a.cllr.t && this.showCallRequest(a.clid, a.rt, a.so, a.cllr), f = b.languageParser.translate("chat", ("v" === a.cllr.t ? "visitor_" : "agent_") + "ringing")) : "in-progress" === a.stts ? (this.removeCallRequest(),
                        f = b.languageParser.translate("chat", "ongoing_call")) : "completed" === a.stts && (g = l.parseChatTime(a.so), this.removeCallRequest(), a.f.vid || a.f.scrn || (m.style.transform = "rotate(135deg)"), callIconContainerEl.style.backgroundColor = "#e52f48", m = {
                        callId: a.clid,
                        ringTimeout: a.rt,
                        startedOn: a.so,
                        caller: a.cllr,
                        isMissed: k
                    }, e || (!b.viewHandler.messagePreview || s.mobileBrowserName) || b.viewHandler.messagePreview.show(b.viewHandler.indicator.unansweredMessages, null, m), k || d ? (f = d ? b.languageParser.translate("chat", "rejected_call") :
                        b.languageParser.translate("chat", "missed_" + ("v" === a.cllr.t ? "agent" : "visitor")), d = b.languageParser.translate("chat", "call_started_on", {
                            startedOn: g
                        ...
                        startedOn: g,
                        duration: d
                    })), (g = l.getElementsByClassName(c.elementReferrer, "callEndDetails")) && g.length && (g[0].innerHTML = d, g[0].style.display = "block")), (c = l.getElementsByClassName(c.elementReferrer, "callTitle")) &&
                    c.length && (c[0].innerHTML = f, k && (c[0].className += " missed")), this.callData[a.clid].ver = a.ver, h && this.scrollToBottom())
            };
            ...
            y.prototype.toggleGreetingsView = function(a) {
                ...
                a || c === d || 5 >= c - d ? 0 === e.scrollTop && -1 !== f.className.indexOf("minimize") &&
                    (f.className = f.className.replace(" minimize", ""), this.chatContainer.getElementById("agentProfileContainer").className = "", 1 === b.agents.agentsCount && this.chatContainer.getElementById("headerAccountStateContainer").classList.remove("multiple-agent"), this.chatContainer.getElementById("shortMessage").style.display = "block") : -1 === f.className.indexOf("minimize") && (f.className += " minimize", this.chatContainer.getElementById("agentProfileContainer").className = "show", 1 < b.agents.agentsCount ? this.chatContainer.getElementById("headerAccountStateContainer").classList.add("multiple-agent") :
                        this.chatContainer.getElementById("headerAccountStateContainer").classList.remove("multiple-agent"), 0 < b.agents.agentsCount && (this.chatContainer.getElementById("shortMessage").style.display = "none"))
            };
            ...
            y.prototype.updateLastTimestamp = function(a) {
                ...
                this.lastUpdateTimeout = setTimeout(function() {
                    !(document.hidden || document.msHidden || document.webkitHidden) && a > r.lastMessageTimestamp && (r.lastMessageTimestamp = a, b.socketManager.sendToConnector("visitorChatSeen", {
                            timestamp: a
                        },
                        function() {}))
                }, 1E3)
            ...
            var J = function() {
                ...
                this.forms = {
                    ...
                    preChatForm: {
                        id: "preChatForm",
                        getTitle: function() {
                            return c.prechatOptions.text ? l.transformGreetings(c.prechatOptions.text) : c.isEmbedded && "page" === $_Tawk_WidgetId && pageType && "profile" === pageType ? b.languageParser.translate("form", "PreChatFormMessageProfile") : b.languageParser.translate("form", "PreChatFormMessage")
                        },
                        dynamicFields: null,
                    ...
                    consentForm: {
                        ...
                        getTitle: function() {
                            return l.transformGreetings(c.consentOption.text).replace(l.regLineBreaks,
                                l.br)
                        },
                        dynamicFields: null,
                        dontCloseForm: !0,
            ...
            J.prototype.openForm = function(a) {
                ...
                if (m && this.currentForm !== a && k) {
                    ...
                    b.viewHandler.chatContainer.getElementById("chatPanel").style.display = "none";
                    k.innerHTML = "";
                    k.appendChild(this.formView.elementReferrer);
                    k.style.display = "block";
                    this.forms[a].getTitle && "consentForm" !== a &&
                        this.forms[a].getTitle() ? (e.innerHTML = this.forms[a].getTitle(), c.style.display = "block") : c.style.display = "none";
                    ...
                    b.viewHandler.chatContainer.attachUserEventListener(a, function(a) {
                        ...
                        p = a.originalEvent ? a.originalEvent : a;
                        t = p.detail ? -40 * p.detail : p.wheelDelta;
                        b = 0 < t;
                        "touchmove" === a.type ? r = a.changedTouches[0].clientY : "touchstart" === a.type ? q = a.touches[0].clientY :
                            "touchend" === a.type && (b = q < r);
                        if (0 === f.scrollTop && -1 !== c.className.indexOf("minimize")) {
                            if (0 > t || q > r) return
                        } else if (-1 === c.className.indexOf("minimize") && (q < r || 0 < t)) return;
                        b || e === d || 5 >= e - d ? 0 === f.scrollTop && -1 !== c.className.indexOf("minimize") && (c.className = c.className.replace(" minimize", "")) : -1 === c.className.indexOf("minimize") && (c.className += " minimize")
                    }, "formFieldsContainer", "formContainerScroll");
                    this.handleResizeofForm()
                }
            };
            J.prototype.handleResizeofForm = function(a) {
                if (!(s.mobileBrowserName || c.isPopup ||
                        c.isEmbedded))
                    if (!b.formHandler.currentForm || a) b.viewHandler.chatContainer.restyle("height", c.maximizedDimensions().height + "px !important");
                        ...
                        var f = 120;
                        "offlineForm" === b.formHandler.currentForm && "block" === b.viewHandler.chatContainer.getElementById("overlayOfflineForm").style.display ? e = b.viewHandler.chatContainer.getElementById("offlineForm") : l.getElementsByClassName(e,
                            "formFrame") ? e = l.getElementsByClassName(e, "formFrame")[0] : (e = l.getElementsByClassName(e, "formTable")[0], f = 60);
                        a && (f += a.offsetHeight);
                        a = e.offsetHeight + f;
            ...
            J.prototype.resize = function() {
                var a, e, f, c, d;
                null !== this.formView && s.mobileBrowserName && (c =
                    b.viewHandler.chatContainer.getElementById("formContainer"), f = b.viewHandler.chatContainer.getElementById("formInnerHeight"), d = b.viewHandler.chatContainer.getElementById("headerBoxWrapper"), c && (a = l.getElementsByClassName(c, "formMessageField"), e = l.getElementsByClassName(c, "longFormContainer"), a && (a.length && e && e.length) && (a = l.getElementsByClassName(c, "longFormBottomContainer")[0].clientHeight, e[0].style.height = b.viewHandler.iframeContainer.clientHeight - d.clientHeight - a + "px"), !f || "android" !== s.mobileBrowserName &&
                        "android2" !== s.mobileBrowserName && "android2.3" !== s.mobileBrowserName || (f.style.overflow = "hidden", b.viewHandler.addOverflowScroll(f))))
            };
            ...
            J.prototype.attachEventListeners = function() {
                ...
                d && b.eventHandler.listen(d, b.viewHandler.clickEvent, function(a) {
                    if (m) return b.eventEmitter.emit(f.formView.formData.saveFunc, {}, function(a,
                        b) {
                        f.handleAfterSave(a, {
                            serverData: b
                        })
                ...
                a && b.eventHandler.listen(a, b.viewHandler.clickEvent, function() {
                    p && (b.viewHandler.chatContainer.getElementById("overlayOfflineForm").style.display =
                ...
                l.forEach(function(a) {
                    if (!a.disabled) {
                        ...
                        e && ("textarea" !== e.nodeName.toLowerCase() && b.eventHandler.listen(e, "keypress", function(a) {
                            13 === a.keyCode && f.submitForm()
                        }, "formkeypress" + a.fieldName), b.eventHandler.listen(e,
                            "keydown",
                            function(a) {
            ...
            J.prototype.submitForm = function() {
                ...
                if (null === a) g.className = "";
                    ...
                    if (this.formView.formData.saveFunc) try {
                        ...
                        e.handleAfterSave(!0), q.handleError("Unable to emit form handler save func : " + this.formView.formData.saveFunc + " with data : " + JSON.stringify(a), h.fileName, h.lineNumber, h.stack)
                    }
                }
            };
            J.prototype.handleAfterSave =
                function(a, e) {
                    var f, c, d, g, h, k, l, m;
                    if (b && b.formHandler.formView && b.formHandler.formView.formData) {
                        ...
                        f && f(e);
                        k ? l.value = "" : (m && (b.viewHandler.chatContainer.getElementById("overlayOfflineForm").style.display = "block", b.viewHandler.chatContainer.getElementById("formFieldsContainer").style.display = "none"), this.formView.formData.dontCloseForm ? this.updateFormStatus() : this.closeForm())
                    }
                };
            J.prototype.updateFormStatus =
                function(a) {
                    var e, f, c;
                    b.viewHandler.chatContainer && (e = b.viewHandler.chatContainer.getElementById("formSavingStatus"), f = b.viewHandler.chatContainer.getElementById("savingStatus"), c = b.viewHandler.chatContainer.getElementById("submitWrapper"), e && f ? a ? (e.className = "errorMessage", f.innerHTML = b.languageParser.translate("form", "errorSaving"), a = l.getElementsByClassName(b.viewHandler.chatContainer.documentRef, "longFormContainer"), a.length && (a[0].scrollTop = 999999999999)) : (e.className = "", f.innerHTML = b.languageParser.translate("form",
                        "saved")) : this.currentForm && "offlineForm" === this.currentForm ? a ? (c.className = "visible", c.innerHTML = "<p>" + b.languageParser.translate("form", "OfflineMessageNotSent") + "</p>", setTimeout(function() {
                        c.className = ""
            ...
            J.prototype.validateForm = function() {
                ...
                if (this.formView) return a = this.formView.formData.fields || [], this.formView.formData.dynamicFields && (a = this.formView.formData.dynamicFields), a.forEach(function(a) {
                    ...
                    e || m || (e = h)
                }), 0 < c ? (e && (a = b.viewHandler.chatContainer.getElementById("formContainer"), a.scrollTop = e.offsetTop), null) : f
            };
            J.prototype.isValidString = function(a, b, f) {
                return f || a ? !(!a || !l.isString(a) ||
                    b && !(b && a.length <= b)) : !0
            };
                ...
                a.forEach(function(a, f) {
                    ...
                    if ("name" !== a.fieldType && "email" !== a.fieldType && "department" !== a.fieldType)
                        if ("choice" === a.fieldType || "option" === a.fieldType) {
                            c = b.viewHandler.chatContainer.documentRef.getElementsByName(a.fieldName + "group");
            ...
            var K = TawkClass.extend({
                init: function() {
                    ...
                    c.isCenterPositioned() ? this.messagePreviewHeight = 0.5 * Math.max(document.documentElement.clientHeight,
                        d.innerHeight || 0) + 0.5 * c.minimizedDimensions().width + 20 - this.messagePreviewOffset + "px" : this.messagePreviewHeight = Math.max(document.documentElement.clientHeight, d.innerHeight || 0) - (c.minimizedDimensions().height + this.offsetY) - this.messagePreviewOffset + "px";
            ...
            K.prototype.updateStatus = function(a) {
                ...
                if (this.container && a) {
                    ...
                    if (e = this.container.getElementById("tawk-minified-mobile-text")) e.innerHTML = "online" === a || "away" === a ? b.languageParser.translate("chat", "chat_text") : b.languageParser.translate("chat", "mail_text");
                    try {
                        b.eventEmitter.emit("resizeIframeHeight")
                    } catch (f) {
                        q.handleError("Unable to emit resizeIframeHeight",
            ...
            K.prototype.bubbleSettingsChanged = function() {
                ...
                b && (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.elementReferrer) && (a && (a.type && "default" !== a.type || this.bubbleContainer.elementReferrer && this.bubbleContainer.insertCssFile(".bubble-text-color{color:" + (c.chatBubble() ? c.chatBubble().fgc :
                    "#ffffff") + ";}", !0), a && (this.bubbleContainer || (this.bubbleContainer = new N(l.getRandomName(), l.getGenericStyle({
                    zindex: "1000000",
                    width: "146px",
                    height: "85px",
                    position: "fixed",
                    ...
                    minheight: "85px",
                    minwidth: "146px"
                }), Y, "iframe")), this.bubbleContainer.elementReferrer || (b.viewHandler.iframeContainer.elementReferrer.appendChild(this.bubbleContainer.buildView(), !0), this.bubbleContainer.buildIframe(b.MinifiedStyle + c.minStyle(),
                    !0)))), this.createBubble(), this.attachBubbleEvents())
            };
            ...
            K.prototype.widgetPositonChanged = function() {
                var a = {},
                    ...
                    f = this.offsetY,
                    d = b + "px";
                c.isCenterPositioned() ? (c.isDesktopRectangle() && (d = 0.5 * c.minimizedDimensions().height - 0.5 *
                        c.minimizedDimensions().width + "px"), c.isRightPositioned() ? (bodyClassName = "center right", a = c.isDesktopRectangle() ? l.getRotateStyling("-90", "49%") : l.getRotateStyling("0", "0"), a.right = d, a.left = "auto !important") : (bodyClassName = "center left", a = c.isDesktopRectangle() ? l.getRotateStyling("90", "49%") : l.getRotateStyling("0", "0"), a.left = d, a.right = "auto !important"), c.isDesktopRectangle() || (a.transform = "unset"), a.top = "calc(50% - " + 0.5 * c.minimizedDimensions().height + "px) !important", a.bottom = "auto !important") :
                    (a = l.getRotateStyling("0", "0"), a.margin = "0px !important", c.isTopPositioned() ? (a.top = f + "px !important", a.bottom = "auto !important", bodyClassName = " top ") : (a.top = "auto !important", a.bottom = f + "px !important", bodyClassName = " bottom "), c.isRightPositioned() ? (bodyClassName += " right ", a.right = b + "px !important", a.left = "auto !important") : (bodyClassName += " left ", a.left = b + "px !important", a.right = "auto !important"));
                this.container.massRestyle(a)
            };
            K.prototype.createBubble = function() {
                var a;
                this.bubbleContainer &&
                    (this.bubbleContainer.elementReferrer && !c.hideWidget && c.chatBubble && !r.chatBubbleClosed()) && (c.chatBubble().type && "default" !== c.chatBubble().type ? this.createImageBubble() : this.createDefaultBubble(), a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-close"), this.bubbleContainer.attachUserEventListener("mouseover", function() {
                            a && (a.style.visibility = "visible")
                        }, null, "bubbleHover"), this.bubbleContainer.attachUserEventListener("mouseout", function() {
                            a && (a.style.visibility = "hidden")
                        }, null, "bubbleOut"),
                        this.bubbleContainer.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
            ...
            K.prototype.calculateBubblePositioning = function(a, b, f, d, g, h, k) {
                ...
                if (c.isCenterPositioned()) {
                    ...
                    q = -0.5 * b;
                    r = d;
                    0 === h ? (m = "gallery" === c.chatBubble().type ?
                        0 : 0.5 * (m - b), f += "px !important") : "gallery" === c.chatBubble().type ? (r = m = 0, f = -1 * (0.5 * (a - b) - d) + "px !important") : (m = 0.5 * (m - a), f = -1 * (0.5 * (a - b) - f) + "px !important");
                    ...
                    h = q - m + r
                } else p = l.getRotateStyling("0", "0"), h = "0", c.isTopPositioned() ? (p.top = d + "px !important", p.bottom = "auto !important", k += " top ") : (p.bottom = d + "px !important", p.top = "auto !important",
                    k += " bottom "), c.isRightPositioned() ? (p.right = f + "px !important", p.left = "auto !important", k += " right ") : (p.left = f + "px !important", p.right = "auto !important", k += " left ");
            ...
            K.prototype.createDefaultBubble = function() {
                ...
                if (a || b) b = l.getElementsByTagName(this.bubbleContainer.documentRef, "body")[0], b.innerHTML = t["tawkchat-chat-bubble-canvas"], a && this.createCanvasChatBubble(), a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-text"), a.innerHTML = c.chatBubble().txt, a.style.color = c.chatBubble().fgc, c.isCenterPositioned() ? (c.isRightPositioned() ? (f = -90, d -= 10, c.isRTL() &&
                    (d = c.minimizedDimensions().width - 146)) : (f = 90, d = c.isDesktopRectangle() ? c.minimizedDimensions().width - 146 + 10 : 10, c.isRTL() && (d = 0)), a = c.minimizedDimensions().height + this.offsetX + 2) : (d = c.minimizedDimensions().height + this.offsetY + 2, a = !c.isRightPositioned() && !c.isRTL() || c.isRightPositioned() && c.isRTL() ? c.isDesktopRectangle() ? c.minimizedDimensions().width - 146 + 16 : 10 : 0), c.isRTL() && (g += " rtl-direction"), this.calculateBubblePositioning(146, 85, a, d, 0, f, g)
            };
            K.prototype.createImageBubble = function() {
                var a, b, f, d;
                f =
                    l.getElementsByTagName(this.bubbleContainer.documentRef, "body")[0];
                var g = c.chatBubble(),
                    h = g.height + 16,
                    k = 0;
                "gallery" === g.type ? (b = parseInt(g.name, 10), d = 22 === b, c.isDesktopRectangle() || (b += "-r"), c.isCenterPositioned() ? (b += c.isRightPositioned() ? "-cr" : "-cl", c.isDesktopRectangle()) : b = c.isTopPositioned() ? b + (c.isRightPositioned() ? "-tr" : "-tl") : b + (c.isRightPositioned() ? "-br" : "-bl"), a = " gallery ", b = "https://static-v.tawk.to/a-v3/images/bubbles/" + b + (d ? ".png" : ".svg"), c.isCenterPositioned() && 0 === g.rotate && (a += " center-right"),
                    f.innerHTML = l.escapeTemplateReplacement(t["tawkchat-chat-bubble-gallery"], [{
                ...
                c.isTopPositioned() || c.isCenterPositioned() ? (k += g.topOffset, c.isCenterPositioned() && 0 === g.rotate && (k -= 16)) : k += g.bottomOffset;
            ...
            K.prototype.toggleBubble = function() {
                c.chatBubble && (this.bubbleContainer && this.bubbleContainer.elementReferrer) && (this.shown && "offline" !== r.pageStatus() ? this.bubbleContainer.restyle("display", "block !important") : this.bubbleContainer.restyle("display", "none !important"))
            };
            K.prototype.agentBarChanged = function(a) {
                ...
                }), k = s.isIE && 10 > s.version, closeIconWidth = 16, minWidth = c.minimizedDimensions().width, minHeight = c.minimizedDimensions().height, b = c.chatBubble(), f = a - minHeight, l = b.rotate, b.type && "default" !== b.type ? (d = b.topOffset, g = b.bottomOffset, bubbleWidth = b.width, bubbleContainerHeight = b.height + closeIconWidth, h = c.isRightPositioned() ? b.rightOffset : b.leftOffset) : (bubbleWidth =
                    146, bubbleContainerHeight = 85, c.isCenterPositioned() ? (h = minHeight + 2, l = c.isRightPositioned() ? -90 : 90) : (d = minHeight + 2, g = minHeight + 2, h = c.isRightPositioned() ? 0 : minWidth - bubbleWidth + closeIconWidth)), c.isCenterPositioned() ? (d = -0.5 * minWidth + 0.5 * a + "px !important", h += f, f = 0 === l ? h + "px !important" : -1 * (0.5 * (bubbleWidth - bubbleContainerHeight) - h) + "px !important", c.isRightPositioned() ? (this.container.restyle("right", d), m.right = f, k && (this.container.restyle("right", a - minWidth + "px !important"), 0 !== l && (m.right = h - (bubbleWidth -
                    bubbleContainerHeight) + "px !important"))) : c.isCenterPositioned() || (this.container.restyle("left", d), m.left = f, k && (this.container.restyle("left", "0px !important"), 0 !== b.rotate && (m.left = h + "px !important"))), k ? this.container.restyle("margin", -0.5 * minWidth + "px 0 0 0 !important") : this.container.restyle("margin", -0.5 * a + "px 0 0 0 !important")) : c.isCenterPositioned() || (c.isTopPositioned() ? m.top = d + f + "px !important" : m.bottom = g + f + "px !important"), this.bubbleContainer && (this.bubbleContainer.elementReferrer && c.chatBubble &&
                    !r.chatBubbleClosed()) && this.bubbleContainer.massRestyle(m))
            };
            ...
            K.prototype.showBubble = function() {
                this.bubbleContainer &&
                    ("offline" !== r.pageStatus() && (!b.viewHandler.messagePreview || b.viewHandler.messagePreview && 1 > b.viewHandler.messagePreview.messagePreviewCount)) && this.bubbleContainer.show()
            };
            ...
            K.prototype.initMessagePreviewContainer = function() {
                ...
                e = e.replace(/__BOTTOM_CONTAINER__/gm,
            ...
            var Aa = K.extend({
                ...
                createCanvasChatBubble: function() {
                    var a, b, f, d, g, h, k, l, m, p, q, r, s, t, v, w, u, x = 5,
                        y = c.chatBubble().bgc;
                    if (a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-canvas")) c.chatPosition(), a.width = "146", a.height = "85", g = a.getContext("2d"), g.clearRect(0, 0, 134, 63), g.fillStyle = y, c.isTopPositioned() ? (x = 16, h = 68, s = x + 3, r = 81, t =
                            6, v = !1, a = 1.1, b = 1.9, f = 1.6, d = 0.85) : (h = x = 6, s = x + 63 - 3, r = 55, t = 79, v = !0, a = 0.9, b = 0.1, f = 0.4, d = 1.15), c.isRTL() ? (u = 10, closeContainerStart = u - 4, k = u + 2, l = u + 5, m = u - 2, p = u - 2, q = u + 5, r = 81, c.isTopPositioned() ? (w = v, f = 0.2, d = 1.45) : (w = !v, f = 0.6, d = 1.85)) : (u = 2, closeContainerStart = u + 134 + 4, k = u + 134 - 2, l = u + 134 - 5, m = u + 134 + 2, p = u + 134 + 2, q = u + 134 - 5, w = v), g.beginPath(), g.moveTo(u + 8, x), g.lineTo(68, x), g.lineTo(u + 134 - 8, x), g.quadraticCurveTo(u + 134, x, u + 134, x + 8), g.lineTo(u + 134, x + 63 - 8), g.quadraticCurveTo(u + 134, x + 63, u + 134 - 8, x + 63), g.lineTo(u + 8, x + 63),
                        g.quadraticCurveTo(u, x + 63, u, x + 63 - 8), g.lineTo(u, x + 8), g.quadraticCurveTo(u, x, u + 8, x), g.strokeStyle = "#e3e0e7", g.lineWidth = 2, g.stroke(), g.closePath(), g.fill(), g.beginPath(), g.arc(68, s, 10, Math.PI * a, Math.PI * b, v), g.strokeStyle = "#e3e0e7", g.lineWidth = 2, g.stroke(), g.fill(), c.isDesktopRectangle() || (c.isTopPositioned() && c.isLeftPositioned() ? r -= 30 : c.isBottomPositioned() && c.isRightPositioned() ? r += 30 : c.isCenterPositioned() && c.isRightPositioned() && (r += 30)), g.beginPath(), g.arc(r, t, 5, 0, 2 * Math.PI, !1), g.strokeStyle = "#e3e0e7",
            ...
            T.prototype.extractRegisterData = function(a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, l.insertScript("https://static-v.tawk.to/695/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
